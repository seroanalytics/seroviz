...
describe("<PlotError />", () => {
    ...
    test("should display error detail if present", () => {
        ...
        expect(alert.textContent)
            .toBe("Facet for nice-plot could not be generated due to the following error:custom message ");
    });
    ...
    test("should display error type if no detail present", () => {
        ...
        const alert = screen.getByRole("alert");
        expect(alert.textContent)
            .toBe("Facet for nice-plot could not be generated due to the following error:API returned an error: OTHER_ERROR ");
    });
    ...
    test("should display home link if type is SESSION_EXPIRED", () => {
        ...
        const alert = screen.getByRole("alert");
        expect(alert.textContent)
            .toBe("Facet for nice-plot could not be generated due to the following error:Session expired. Re-upload your data to continue.");
